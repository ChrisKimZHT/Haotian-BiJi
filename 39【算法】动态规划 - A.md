...
- 从 $1\sim i$ 个物品选取，总体积 $<j$ ，且不选第 $i$ 个物品的选法。

  - 结果等于 $dp(i-1,j)$

- 从 $1\sim i$ 个物品选取，总体积 $<j$ ，且选第 $i$ 个物品的选法。
  - 结果等于 $dp(i-1,j-v_i)+w_i$（此处 $v$ 为体积，$w$ 为权重/价值）
...
- 从 $1\sim i$ 个物品选取，总体积 $<j$ ，且选 $0$ 个第 $i$ 个物品的选法。

  - 结果等于 $dp(i-1,j)$

- 从 $1\sim i$ 个物品选取，总体积 $<j$ ，且选 $1$ 个第 $i$ 个物品的选法。

  - 结果等于 $dp(i-1,j-1\times v_i)+1\times w_i$

- 从 $1\sim i$ 个物品选取，总体积 $<j$ ，且选 $2$ 个第 $i$ 个物品的选法。

  - 结果等于 $dp(i-1,j-2\times v_i)+2\times w_i$

  $\cdots\cdots\cdots\cdots$

- 从 $1\sim i$ 个物品选取，总体积 $<j$ ，且选 $k$ 个第 $i$ 个物品的选法。$(k\leq j/v_i)$

  - 结果等于 $dp(i-1,j-k\times v_i)+k\times w_i$
